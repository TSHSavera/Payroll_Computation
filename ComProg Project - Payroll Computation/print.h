...
void printOutValues(char calcuType = ' ', std::string name = " ", char employeeCode = ' ', double customEmployeeRate = -1, int presentDays = -1, char shiftType = ' ', char dependencyStatus = ' ', int numberOfPresentOnHoliday = -1, int numberOfPresentOnRestDay = -1, int numberOfPresentOnRestHoliDay = -1, int numberOfOvertimeHours = -1, int numberOfSpecialOvertimeHours = -1) {
    ...
    if (employeeCode != ' ') {
        if (customEmployeeRate != -1) {
            ...
            std::cout << "\t\t\t+-----------------------------------------+" << std::endl;
            std::cout << "\t\t\t| 3. Custom Employee Rate: " << customEmployeeRate << "\t\t  |" << std::endl;
            std::cout << "\t\t\t+-----------------------------------------+" << std::endl;

            if (presentDays != -1) {
                std::cout << "\t\t\t| 4. Number of Present Days: " << presentDays << "\t\t  |" << std::endl;
                std::cout << "\t\t\t+-----------------------------------------+" << std::endl;
            }

            if (shiftType != ' ') {
                if (shiftType == '1') {
                    std::cout << "\t\t\t| 5. Shift Type: Regular Shift" << "\t\t  |" << std::endl;
                    std::cout << "\t\t\t+-----------------------------------------+" << std::endl;
                }
                else if (shiftType == '2') {
                    std::cout << "\t\t\t| 5. Shift Type: Night Shift" << "\t\t  |" << std::endl;
                    std::cout << "\t\t\t+-----------------------------------------+" << std::endl;
                }
            }
            ...
            if (dependencyStatus != ' ') {
                if (dependencyStatus == '2') {
                    std::cout << "\t\t\t\| 6. Dependency Type: Without Dependents" << "  |" << std::endl;
                    std::cout << "\t\t\t+-----------------------------------------+" << std::endl;
                }
                else if (dependencyStatus == '1') {
                    std::cout << "\t\t\t\| 6. Dependency Type: With Dependents" << "\t  |" << std::endl;
                    std::cout << "\t\t\t+-----------------------------------------+" << std::endl;
                }
            }

            if (numberOfPresentOnHoliday != -1) {
                std::cout << "\t\t\t| 7. Number of Present on Holidays: " << numberOfPresentOnHoliday << "\t  |" << std::endl;
                std::cout << "\t\t\t+-----------------------------------------+" << std::endl;
            }


            if (numberOfPresentOnRestDay != -1) {
                std::cout << "\t\t\t| 8. Number of Present on Restday: " << numberOfPresentOnRestDay << "\t  |" << std::endl;
                std::cout << "\t\t\t+-----------------------------------------+" << std::endl;
            }

            if (numberOfPresentOnRestHoliDay != -1) {
                std::cout << "\t\t\t| 9. Number of Present on Rest/Holiday: " << numberOfPresentOnRestHoliDay << " |" << std::endl;
                std::cout << "\t\t\t+-----------------------------------------+" << std::endl;
            }

            if (numberOfOvertimeHours != -1) {
                std::cout << "\t\t\t| 10. Number of Overtime Hours: " << numberOfOvertimeHours << "\t  |" << std::endl;
                std::cout << "\t\t\t+-----------------------------------------+" << std::endl;
            }

            if (numberOfSpecialOvertimeHours != -1) {
                std::cout << "\t\t\t| 11. Number of SP Overtime Hours: " << numberOfSpecialOvertimeHours << "   \t  |" << std::endl;
                std::cout << "\t\t\t+-----------------------------------------+" << std::endl;
            }
        }
        else {
